  ...
  dropAccnt() {
    return (
      <Dropdown nav isOpen={this.state.dropdownOpen} toggle={this.toggle}>
        <DropdownToggle nav>
          <img src={'assets/img/avatars/avatar.png'} className="img-avatar" alt="" />
        </DropdownToggle>
        <DropdownMenu right style={{width:"200px"}}>
          <DropdownItem header tag="div" className="text-center"><strong>{this.state.name} {this.state.surname}</strong></DropdownItem>

          <DropdownItem><i className="fa fa-lock"></i> <a href="logout.jsp">Logout</a></DropdownItem>
          <DropdownItem header tag="div" className="text-center"><strong>Terms and conditions</strong></DropdownItem>
          <DropdownItem><span style={{fontSize:"10px"}}><i className="fa fa-check" style={{color:"green"}}></i> accepted on {this.state.privacy}</span></DropdownItem>
        </DropdownMenu>
      </Dropdown>
    );
  }
